...
class Pending extends Component{
  ...
  handleClickReject(e){
    ...
    let re = this.state.nightStudyReasonForRejection;
    if( re === ''){
      re = 'Meet me in person';
    }
    var newUserData = {
      "nightStudyStatus" : "Rejected",
      "nightStudyReasonForRejection": re
    }    
    itemReff.child(this.props.id).update(newUserData);
    this.setState({nightStudyStatus: "Rejected", nightStudyReasonForRejection: re});
  }
  render(){
    let prin;
    if(this.state.nightStudyStatus === "Pending" || this.state.nightStudyStatus === "pending")
    {
      prin =<div>
    ...
    else if (this.state.nightStudyStatus === "Approved" || this.state.nightStudyStatus === "approved"){
      prin = <Approved/>
    }
    else if(this.state.nightStudyStatus === "Rejected" || this.state.nightStudyStatus === "rejected"){
