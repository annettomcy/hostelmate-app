...
class Pending extends Component{
  ...
  handleClickReject(e){
    ...
    let re = this.state.sickLeaveReasonForRejection;
    if( re === ''){
      re = 'Meet me in person';
    }
    var newUserData = {
      "sickLeaveStatus" : "Rejected",
      "sickLeaveReasonForRejection": re
    }
    itemReff.child(this.props.id).update(newUserData);
    this.setState({sickLeaveStatus: "Rejected", sickLeaveReasonForRejection: re});
  }
  render(){
    let prin;
    if(this.state.sickLeaveStatus === "Pending" || this.state.sickLeaveStatus === "pending" )
    {
      prin =<div>
    ...
    else if (this.state.sickLeaveStatus === "Approved" || this.state.sickLeaveStatus === "approved"){
      prin = <Approved/>
    }
    else if(this.state.sickLeaveStatus === "Rejected" || this.state.sickLeaveStatus === "rejected"){
